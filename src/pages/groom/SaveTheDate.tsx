  ...
  return (
    <GroomLayout>
      <div className="flex flex-col items-center text-center mb-12">
        ...
        <p className="text-lg md:text-xl mb-12 max-w-2xl animate-slide-up text-white font-normal">
        ...
        <div className="w-full md:w-2/3 p-8 rounded-lg animate-fade-in bg-groom-accent/20 border border-groom-border">
          <div className="flex flex-col md:flex-row justify-around items-center gap-8">
            <div className="text-center">
              ...
              <h2 className="text-2xl mb-2 text-white font-bold">July 13, 2025</h2>
              <p className="text-white font-normal">Sunday, 11:00 AM - 2:30 PM</p>
            </div>
            
            <div className="text-center">
              <MapPin className="h-12 w-12 mx-auto mb-4 text-white" />
              <h2 className="text-2xl mb-2 text-white font-bold">Kbees Durbar Convention Center</h2>
              <p className="text-white font-normal">Reception Lunch</p>
            </div>
          </div>
